...
Все указанные специалисты и объединения приведены только для примера. В качестве примера взяты только 2 реальных экрана - просмотр и создание счетов. В реальных условиях возможно проектирование своих специалистов и объединений, реализующий необходимый только вам функционал. 
