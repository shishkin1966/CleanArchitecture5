...
Все указанные специалисты и объединения приведены только для примера. В качестве примера взяты только 3 реальных экрана - просмотр и создание счетов, курсы криптовалют. Данный образец можно рассматривать как объединение архитектурного шаблона VIPER с Service Locator. Образец охватывает максимально широкий спектр задач и ситуаций. В реальных условиях возможно проектирование своих специалистов и объединений, реализующий необходимый только вам функционал.
